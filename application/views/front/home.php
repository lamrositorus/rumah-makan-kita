<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo base_url().'public/front/img/2.jpg';?>" alt="FriesBrgrImg">
        ...
        <div class="carousel-item">
            <img src="<?php echo base_url().'public/front/img/3.jpg';?>" alt="Spaghetti">
        ...
        <div class="carousel-item">
            <img src="<?php echo base_url().'public/front/img/1.jpg';?>" alt="corn">
            <div class="carousel-caption text-right">
                <h1 class="display-2">>Anda membutuhkan makanan!</h1>
                <h3>kami di sini untuk melayani Anda</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">Order Now</a>
...
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Pilih Meja</h3>
            <p>Hal pertama yang dapat Anda lakukan adalah memilih meja untuk direservasi dengan mudah!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
